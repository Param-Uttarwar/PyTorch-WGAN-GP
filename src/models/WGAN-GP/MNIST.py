...
class model():
    ...
    def calc_gradient_penalty(self,modelD, real_data, fake_data):
        ...
        for epoch in range(self.parameters['num_epochs']):
            ...
            for i, (data,_) in enumerate(self.train_loader):
                ...
                for j in range(5):
                    ...
                    #Discriminator pred
                    predD=self.modelD(inpDR).squeeze()
                    ...
                    #Discriminator pred
                    predD=self.modelD(inpDF.detach())
                    ...
                    gradient_penalty = self.calc_gradient_penalty(self.modelD, inpDR.data, inpDF.data)
